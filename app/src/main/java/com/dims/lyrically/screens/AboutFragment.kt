...
class AboutFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return AboutPage(requireContext())
                ...
                .addItem(Element("Icon made by Freepik from www.flaticon.com", R.drawable.ic_empty_box)
                        .setIntent(getIntent("https://www.flaticon.com/authors/freepik")))
                .addItem(Element("Icon made by Pixel perfect from www.flaticon.com", R.drawable.ic_error_icon)
                        .setIntent(getIntent("https://www.flaticon.com/authors/pixel-perfect")))
